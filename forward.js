...
app.forward_target = process.env.FORWARD_TARGET || 'http://en.wikipedia.org/wiki';
app.get(/.*/, function(req, res) {
	var destination = process.env.NO_ARG ? app.forward_target : app.forward_target + req.url;
...
app.listen(port, function() {
	console.log("Listening on " + port + " forwarding to " + app.forward_target);
});
